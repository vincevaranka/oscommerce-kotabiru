...
<?php
  ...
  $file_contents = '<?php' . "\n" .
				   ...
				   '  define(\'DIR_WS_IMAGES_PRODUCT\', \'images/product/\');'. "\n".
				   '  define(\'DIR_WS_IMAGES_MANUFACTURE\', \'images/manufacture/\');'. "\n".
				   '  define(\'DIR_WS_IMAGES_CATEGORY\', \'images/category/\');'. "\n".
				   '  define(\'DIR_WS_IMAGES_SLIDER\', \'images/slider/\');'. "\n".
				   '  define(\'DIR_WS_THEME\', \'theme/\');'. "\n".
				   '  define(\'DIR_WS_THEME_MODULE\',\'/module/\');'. "\n".
  ...
  $file_contents = '<?php' . "\n" .
                   ...
                   '  define(\'DIR_FS_CATALOG\', \'' . $dir_fs_document_root . '\');' . "\n" .
                   '  define(\'DIR_WS_IMAGES\', \'images/\');' . "\n" .
				   '  define(\'DIR_WS_CATALOG_IMAGES_PRODUCT\', DIR_WS_CATALOG . \'images/product/\');' ."\n".
				   '  define(\'DIR_WS_CATALOG_IMAGES_MANUFACTURE\', DIR_WS_CATALOG . \'images/manufacture/\');' ."\n".
				   '  define(\'DIR_WS_CATALOG_IMAGES_CATEGORY\', DIR_WS_CATALOG . \'images/category/\');' ."\n".
				   '  define(\'DIR_WS_CATALOG_IMAGES_SLIDE\', DIR_WS_CATALOG . \'images/slide/\');' ."\n".
                   '  define(\'DIR_WS_ICONS\', DIR_WS_IMAGES . \'icons/\');' . "\n" .
				   ...
				   '  define(\'DIR_FS_CATALOG_IMAGES_PRODUCT\', DIR_FS_CATALOG . \'images/product/\');' . "\n" .
				   '  define(\'DIR_FS_CATALOG_IMAGES_MANUFACTURE\', DIR_FS_CATALOG . \'images/manufacture/\');' . "\n" .
				   '  define(\'DIR_FS_CATALOG_IMAGES_CATEGORY\', DIR_FS_CATALOG . \'images/category/\');' . "\n" .
				   '  define(\'DIR_FS_CATALOG_IMAGES_SLIDE\', DIR_FS_CATALOG . \'images/slide/\');' . "\n" .
