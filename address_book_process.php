...
?>
  ...
  <div>
    <span style="float: right;"><?php echo tep_draw_hidden_field('action', 'update') . tep_draw_hidden_field('edit', $HTTP_GET_VARS['edit']) . tep_draw_button_booth(IMAGE_BUTTON_UPDATE, 'refresh', null, 'primary'); ?></span>

    <?php echo tep_draw_button_booth(IMAGE_BUTTON_BACK, 'chevron-left', tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL')); ?>
  </div>
...
?>
 ...
 <hr />
   <?php echo tep_draw_hidden_field('action', 'process') . tep_draw_button_booth(IMAGE_BUTTON_CONTINUE, 'save', null, 'primary'); ?></span>
    <?php echo tep_draw_button_booth(IMAGE_BUTTON_BACK, 'chevron-left', $back_link); ?>
