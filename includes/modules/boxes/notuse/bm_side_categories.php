<?php
  class bm_side_categories {
    var $code = 'bm_side_categories';
    var $group = 'boxes';
    var $title;
    var $description;
    var $sort_order;
    ...
    function bm_side_categories() {
      ...
      if ( defined('MODULE_BOXES_CATEGORIES_STATUS') ) {
		...
		$this->placement = MODULE_BOXES_CATEGORIES_CONTENT_PLACEMENT;
      }
    }
    ...
    function execute() {
	  ...
	  $data = '<div class="box">' .
              '  <div class="box-heading">' . MODULE_BOXES_CATEGORIES_BOX_TITLE.'</div>' .
