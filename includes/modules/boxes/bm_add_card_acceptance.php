...
*/
  ...
  class bm_add_card_acceptance {
    var $code = 'bm_add_card_acceptance';
    var $group = 'boxes';
    var $title;
    var $description;
    var $sort_order;
    ...
    function bm_add_card_acceptance() {
      ...
      if ( defined('MODULE_BOXES_CARD_ACCEPTANCE_STATUS') ) {
        ...
        $this->group = ((MODULE_BOXES_CARD_ACCEPTANCE_CONTENT_PLACEMENT == 'Powered Right') ? 'boxes_column_powered_right' : '');
      }
    }
