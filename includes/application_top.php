...
if(isset($HTTP_GET_VARS['disp'])){
	$disp = $HTTP_GET_VARS['disp'];
	tep_session_register('disp');
  }
  if(!tep_session_is_registered('disp')){
	$disp = '1';
	tep_session_register('disp');
  }
  if(isset($HTTP_GET_VARS['limit'])){
	$limit = $HTTP_GET_VARS['limit'];
	tep_session_register('limit');
  }
  if(!tep_session_is_registered('limit')){
	$limit = '6';
	tep_session_register('limit');
  }
