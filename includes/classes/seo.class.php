        ...
        function SEO_URL($languages_id){
            global $session_started, $SID;
                ...
                $seo_pages = array(FILENAME_DEFAULT,
                                   ...
                                   if ( defined('FILENAME_ARTICLE') ) $seo_pages[] = FILENAME_ARTICLE;
								   if ( defined('FILENAME_TESTIMONIAL') ) $seo_pages[] = FILENAME_TESTIMONIAL;
...
//ojp generate_link_cache
                ...
                if ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true'){
						...
						if ( $this->attributes['USE_SEO_CACHE_TESTIMONIAL'] == 'true' && defined('TABLE_TESTIMONIAL')) $this->generate_articles_cache();
  ...
  function stock_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true) {
    ...
    if ( (SEARCH_ENGINE_FRIENDLY_URLS == 'true') && ($search_engine_safe == true) ) {
      ...
      $separator = '?';
        ...
        function parse_parameters($page, $params, &$separator){
                ...
                foreach ($p as $index => $valuepair){
                        $p2 = @explode('=', $valuepair); 
						  $cID = strstr_after($p2[1],'_');
						  if(!empty($cID)) {
						  $cName = $this->get_all_category_names($cID, $cName).'/';
							}
                        switch ($p2[0]){ 
                                case 'products_id':
                                        switch(true){
                                                case ( $page == FILENAME_PRODUCT_INFO && !$this->is_attribute_string($p2[1]) ):
                                                        $url = $this->make_url($page, $this->get_product_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                                case ( $page == FILENAME_PRODUCT_REVIEWS ):
                                                        $url = $this->make_url($page, $this->get_product_name($p2[1]), 'products_id_review', $p2[1], '');
                                                        break;
                                                case ( $page == FILENAME_PRODUCT_REVIEWS_INFO ):                                                        
                                                        $url = $this->make_url($page, $this->get_product_name($p2[1]), 'products_id_review_info', $p2[1], '');
                                                        break;
                                                default:
                                                        $container[$p2[0]] = $p2[1];
                                                        break;
                                ...
                                case 'cPath':
                                        switch(true){
                                                case ($page == FILENAME_DEFAULT):
                                                        $url = $this->make_url($page, $cName.$this->get_category_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                ...
                                case 'manufacturers_id':
                                        switch(true){
                                                case ($page == FILENAME_DEFAULT && !$this->is_cPath_string($params) && !$this->is_product_string($params) ):
                                                        $url = $this->make_url($page, $this->get_manufacturer_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                ...
                                case 'tPath':
                                        switch(true){
                                                case ($page == FILENAME_ARTICLE):
                                                        $url = $this->make_url($page, $this->get_topic_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                                default:
                                                        $container[$p2[0]] = $p2[1];
                                                        break;
                  				   ...
                  				   case 'lPath':  //Links Manager II
                  					 switch(true){
                  						case ($page == FILENAME_LINKS):
                  							$url = $this->make_url($page, $this->get_link_name($p2[1]), $p2[0], $p2[1], '');
                                    break;
                  						default:
                  							$container[$p2[0]] = $p2[1];
                  							break;
                  				   ...
                  				   case 'fl':  //All Products SEO
                  					 switch(true){
                  						case ($page == FILENAME_ALLPRODS_SEO):
                  							$url = $this->make_url($page, FILENAME_ALLPRODS_SEO, $p2[0], $p2[1], '');
                                    break;
                  						default:
                  							$container[$p2[0]] = $p2[1];
                  							break;
                                 ...
                                 case 'articles_id':
                                        switch(true){
                                                case ($page == FILENAME_ARTICLE):
                                                        $url = $this->make_url($page, $this->get_article_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                                default: 
                                                        $container[$p2[0]] = $p2[1];
                                                        break;
                                  ...
                                  case 'tID':
                                        switch(true){
                                                case ($page == FILENAME_TESTIMONIAL):
                                                        $url = $this->make_url($page, $this->get_testimonial_name($p2[1]), $p2[0], $p2[1], '');
                                                        break;
                                                default: 
                                                        $container[$p2[0]] = $p2[1];
                                                        break;
                   				  ...
                   				  case 'authors_id':
                    					switch(true){
                    						case ($page == FILENAME_ARTICLES):
                    							$url = $this->make_url($page, $this->get_authors_name($p2[1]), $p2[0], $p2[1], '');
                    							break;
                    						default:
                    							$container[$p2[0]] = $p2[1];
                    							break;
                                ...
                                case 'info_id': //Information Pages
                                     switch(true){
                                             case ($page == FILENAME_INFORMATION):
                                                     $url = $this->make_url($page, $this->get_information_name($p2[1]), $p2[0], $p2[1], '');
                                                     break;
                                             default: 
                                                     $container[$p2[0]] = $p2[1];
                                                     break;
                       				...
                       				case 'pages_id': // Page Editor
                       					switch(true){
                       						case ($page == FILENAME_PAGES):
                       							$url = $this->make_url($page, $this->get_page_editor_name($p2[1]), $p2[0], $p2[1], '');
                       							break;
                       						default: 
                       							$container[$p2[0]] = $p2[1];
                       							break;
	                            ...
	                            case 'faqdesk_id':
                                     switch(true){
                                             case ($page == FILENAME_FAQDESK_INFO):
                                                     $url = $this->make_url($page, $this->get_faqdesk_name($p2[1]), $p2[0], $p2[1], '');
                                                     break;
                           ...
                           case 'faqPath':
                                   switch(true){
                                           case ($page == FILENAME_FAQDESK_INDEX):
                                                   $url = $this->make_url($page, $this->get_faqdesk_categories_name($p2[1]), $p2[0], $p2[1], '');
                                                   break;
                                           default: 
                                                   $container[$p2[0]] = $p2[1];
                                                   break;
                                ...
                                case 'pollid':
                                   switch(true){
                                           case ($page == 'pollbooth.php'):
                                                   $url = $this->make_url($page, $this->get_pollbooth($p2[1]), $p2[0], $p2[1], '');
                                                   break;
                                           default: 
                                                   $container[$p2[0]] = $p2[1];
                                                   break;
                      		    ...
                      		    case 'newsdesk_id':
                                   switch(true){
                                           case ($page == FILENAME_NEWSDESK_INFO):
                                                   $url = $this->make_url($page, $this->get_newsdesk_name($p2[1]), $p2[0], $p2[1], '');
                                                   break;
							               case ($page == FILENAME_NEWSDESK_REVIEWS_INFO):
                                                   $url = $this->make_url($page, $this->get_newsdesk_name($p2[1]), 'newsdesk_reviews_id', $p2[1], '');
                                                   break;
							               case ($page == FILENAME_NEWSDESK_REVIEWS_ARTICLE):
                                                   $url = $this->make_url($page, $this->get_newsdesk_name($p2[1]), 'newsdesk_article_id', $p2[1], '');
                                                   break;
                                           default: 
                                                   $container[$p2[0]] = $p2[1];
                                                   break;
                                 ...
                                 case 'newsPath':
                                   switch(true){
                                           case ($page == FILENAME_NEWSDESK_INDEX):
                                                   $url = $this->make_url($page, $this->get_newsdesk_categories_name($p2[1]), $p2[0], $p2[1], '');
                                                   break;
                                           default: 
                                                   $container[$p2[0]] = $p2[1];
                                                   break;
                ...
                switch(true){
                        ...
                        default:
                                ...
                                if ($this->attributes['USE_SEO_HEADER_TAGS'] == 'true') {
                                  ...
                                  $sql = "SELECT article_name as aName  
                                                FROM ".TABLE_ARTICLE." 
                                                WHERE article_id='".(int)$aID."'  
                                                LIMIT 1";
                                }
		...
		function get_testimonial_name($tID){
                switch(true){
                        case ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true' && defined('TESTIMONIAL_NAME_' . $tID)):
                                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') $this->performance['CACHE_QUERY_SAVINGS']++;
                                $return = constant('TESTIMONIAL_NAME_' . $tID);
                                $this->cache['TESTIMONIAL'][$tID] = $return;
                                break;
                        case ($this->attributes['USE_SEO_CACHE_GLOBAL'] == 'true' && isset($this->cache['TESTIMONIAL'][$tID])):
                                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') $this->performance['CACHE_QUERY_SAVINGS']++;
                                $return = $this->cache['TESTIMONIAL'][$tID];
                                break;
                        default:
                                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') $this->performance['NUMBER_QUERIES']++;
                                ...
                                if ($this->attributes['USE_SEO_HEADER_TAGS'] == 'true') {
                                  $sql = "SELECT page_title as aName 
                                                  FROM ".TABLE_HEADERTAGS." 
                                                  WHERE page_name LIKE '%tID=".$tID."' 
                                                  AND language_id='".(int)$this->languages_id."' 
                                                  LIMIT 1";                                
                                } else {
                                  $sql = "SELECT testi_name as aName  
                                                FROM ".TABLE_TESTIMONIAL." 
                                                WHERE testi_id='".(int)$tID."'  
                                                LIMIT 1";
                                }

                                $result = $this->DB->FetchArray( $this->DB->Query( $sql ) );
                                $aName = $this->strip( $result['aName'] );
                                $this->cache['TESTIMONIAL'][$tID] = $aName;
                                if ($this->attributes['USE_SEO_PERFORMANCE_CHECK'] == 'true') $this->performance['QUERIES']['ARTICLES'][] = $sql;
                                $return = $aName;
                                break;                                                                
                }           
