...
define('ENTRY_DATE_OF_BIRTH', 'Please select date of birth');
...
/**++++**/
define('TEXT_MY_CART','My Cart');
define('TEXT_CART_EMPTY','Cart is empty');
define('HEADER_TITLE_CATEGORY','Products');
define('HEADER_TITLE_NEW','New Coming');
define('HEADER_TITLE_SPECIAL','SALE');
define('HEADER_TITLE_BEST','Recommended');
define('IMAGE_BUTTON_REVIEWS_SEE_ALL','See All');
define('IMAGE_BUTTON_SIGN_UP','Sign Up');
define('TEXT_SORT_A_TO_Z','A to Z');
define('TEXT_SORT_Z_TO_A','Z to A');
define('TEXT_SORT_LOWEST_PRICE','Lowest Price');
define('TEXT_SORT_HIGHEST_PRICE','Highest Price');
define('HEADER_TITLE_ACCOUNT_HISTORY','Account History');
define('HEADER_TITLE_ADDRESS_BOOK','Address Book');
define('HEADER_TITLE_ADVANCED_SEARCH','Advanced Search');
define('TEXT_SEARCH_PLACEHOLDER','What you looking for..');
define('TEXT_ABOUT_US','About Us');
define('TEXT_SHIPPING','Shipping and Return');
define('TEXT_CONDITIONS','Conditions');
define('TEXT_PRIVACY','Privacy');
define('TEXT_CALL_US','Call Us Now : ');
?>
