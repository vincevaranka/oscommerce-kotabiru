...
// Output a jQuery UI Button
 ...
 /***+++++****/
  function tep_draw_button_booth($title = null, $icon = null, $link = null, $priority = null, $params = null) {
    static $button_counter = 1;
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
      $button .= '<a class="btn btn-'.$priority.'" id="tdb' . $button_counter . '" href="' . $link . '"';
