...
r=f("<div />").attr({"class":b.classstatusdiv+" preloadevt"}).css({position:"absolute",display:"none",zIndex:g,top:0,left:0}).html('<img src="'+b.loadinggif+'" />').appendTo(document.body);h=f("<div />").attr({"class":"tracker"}).css({zIndex:g,position:"absolute",width:n.c,height:n.d,left:d.offsetsl().left,top:d.offsetsl().top}).appendTo(document.body);s=f("<div />");B&&(s.attr({"class":b.classtextdn}).css({position:"absolute",zIndex:g,left:0,top:0,display:"none"}).html(B).appendTo(document.body),
