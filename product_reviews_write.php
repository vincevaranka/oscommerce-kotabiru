  ...
  <div class="contentText">
    <table border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_textarea_field('review', 'soft', 60, 15,'','class="form-control"') . '<br /><span style="float: right;">' . TEXT_NO_HTML . '</span>'; ?></td>
      </tr>
      <tr>
...
<hr />
  <div class="buttonSet">
    <span class="buttonAction"><?php echo tep_draw_button_booth(IMAGE_BUTTON_CONTINUE, 'chevron-right', null, 'primary'); ?></span>

    <?php echo tep_draw_button_booth(IMAGE_BUTTON_BACK, 'chevron-left', tep_href_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params(array('reviews_id', 'action')))); ?>
  </div>
</div>
