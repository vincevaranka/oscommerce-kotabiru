...
<div class="content">
	...
	<div class="progressCheckout text-center">
	  ...
	  <div class="bar-item"><i class="glyphicon glyphicon-usd"></i><?php echo CHECKOUT_BAR_PAYMENT; ?></div>
	  <div class="bar-item"><i class="glyphicon glyphicon-ok"></i><?php echo CHECKOUT_BAR_CONFIRMATION; ?><br />Order</div>
    </div>
...
<?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'), 'post', '', true) . tep_draw_hidden_field('action', 'process'); ?>
 ...
 <div class="row">
  ...
  <?php echo TEXT_CHOOSE_SHIPPING_DESTINATION; ?><br /><br /><?php echo tep_draw_button_booth(IMAGE_BUTTON_CHANGE_ADDRESS, 'home', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'),'primary'); ?>
  </div>
  <div class="col-md-6 col-address">
	<div class="address">
	<h2><?php echo TITLE_SHIPPING_ADDRESS; ?></h2>
	<div>
...
<div>
  ...
  <div class="contentText">
    ...
    <div class="text-right"><?php echo tep_draw_button_booth(IMAGE_BUTTON_CONTINUE, 'play', null, 'primary'); ?></div>
