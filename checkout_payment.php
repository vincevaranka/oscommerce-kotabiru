...
<div class="row">
  <div class="col-md-6">
	...
	<?php echo TEXT_SELECTED_BILLING_DESTINATION; ?><br /><br /><?php echo tep_draw_button_booth(IMAGE_BUTTON_CHANGE_ADDRESS, 'home', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL'),'primary'); ?>
  </div>
  <div class="col-md-6 col-address">
	 <div class="address">
	<h2><?php echo TITLE_BILLING_ADDRESS; ?></h2>
	<div>
