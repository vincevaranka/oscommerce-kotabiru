...
// define the filenames used in the project
  ...
  define('FILENAME_SLIDER','slider.php');
  define('FILENAME_FONTS','fonts.php');
  define('FILENAME_INFORMATION','information.php');
  define('FILENAME_FOLLOW_US','follow_us.php');
  define('FILENAME_TESTIMONIAL','testimonial.php');
  define('FILENAME_BANNER','banner.php');
  define('FILENAME_THEME','theme.php');
?>
