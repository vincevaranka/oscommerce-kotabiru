...
///CUSTOM +++ kotabiru.com
// categories box text in includes/boxes/catalog.php
define('BOX_HEADING_CUSTOM', 'Custom +');
define('BOX_CUSTOM_SLIDER', 'Slider');
define('BOX_CUSTOM_FONTS', 'Google Fonts');
define('BOX_CUSTOM_INFORMATION','Information');
define('BOX_CUSTOM_FOLLOW_US','Follow Us');
define('BOX_CUSTOM_TESTIMONIAL','Testimonial');
define('BOX_CUSTOM_BANNER','Banners');
define('BOX_CUSTOM_THEME','Theme');
//
