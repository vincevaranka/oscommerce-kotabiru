...
*/
  ...
  class tableBlock {
    ...
    function __construct($contents) {
      ...
      $tableBox_string .= '<div class="table-responsive"><table border="' . $this->table_border . '" width="' . $this->table_width . '" cellspacing="' . $this->table_cellspacing . '" cellpadding="' . $this->table_cellpadding . '"';
