...
<?php
  if ($action == 'list_new') {
    echo '' . tep_draw_button_bs(IMAGE_BACK, 'triangle-1-w', tep_href_link('modules_content.php')) . '';
  } else {
    echo '' . tep_draw_button_bs(IMAGE_MODULE_INSTALL . ' (' . count($modules['new']) . ')', 'plus', tep_href_link('modules_content.php', 'action=list_new')) . '';
  }
?>
</div>
</div>
...
<?php
  ...
  switch ($action) {
    case 'edit':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_draw_button_bs(IMAGE_SAVE, 'disk', null, 'primary') . tep_draw_button_bs(IMAGE_CANCEL, 'close', tep_href_link('modules_content.php', 'module=' . $mInfo->code)));
    ...
    default:
      if ( isset($mInfo) ) {
        ...
        if ($action == 'list_new') {
          $contents[] = array('align' => 'center', 'text' => tep_draw_button_bs(IMAGE_MODULE_INSTALL, 'plus', tep_href_link('modules_content.php', 'module=' . $mInfo->code . '&action=install')));
          ...
          $contents[] = array('align' => 'center', 'text' => tep_draw_button_bs(IMAGE_EDIT, 'edit', tep_href_link('modules_content.php', 'module=' . $mInfo->code . '&action=edit')) . tep_draw_button_bs(IMAGE_MODULE_REMOVE, 'minus', tep_href_link('modules_content.php', 'module=' . $mInfo->code . '&action=remove')));
